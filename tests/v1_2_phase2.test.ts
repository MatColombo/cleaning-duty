...
function task(overrides: Partial<TaskOccurrence> = {}): TaskOccurrence { return { id:tid,workspaceId:wid,routineId:rid,routineRevision:1,routineNameSnapshot:'Vacuum living room',actionNameSnapshot:'Vacuum',cleanlinessChannel:'regular',careLevel:'routine',scheduledSlotAt:'2026-08-31T09:00:00.000Z',effectiveDueAt:'2026-08-31T09:00:00.000Z',originalDueAt:'2026-08-31T09:00:00.000Z',dueAt:'2026-08-31T09:00:00.000Z',state:'scheduled',assignmentScope:'member',assigneeMemberId:mid,targets:[{entityId:eid,entityName:'Living room floor',entityTypeName:'Surface',matchReasons:['Selected']}],supplies:[],explanation:{schedule:'Daily',assignment:'Me',targetSummary:'Floor'},version:1,createdAt:'2026-08-30T09:00:00.000Z',...overrides} }
