...
const baseTask: TaskOccurrence = { id:'t',workspaceId:'w',routineId:'r',routineRevision:1,routineNameSnapshot:'Routine',actionNameSnapshot:'Clean',cleanlinessChannel:'regular',careLevel:'routine',scheduledSlotAt:'2026-08-31T09:00:00Z',effectiveDueAt:'2026-09-01T09:00:00Z',originalDueAt:'2026-08-31T09:00:00Z',dueAt:'2026-09-01T09:00:00Z',state:'scheduled',assignmentScope:'unassigned',targets:[],supplies:[],explanation:{schedule:'',assignment:'',targetSummary:''},version:2,createdAt:'2026-08-01T00:00:00Z' }
